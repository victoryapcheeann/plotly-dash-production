...
url5 = "https://assets8.lottiefiles.com/packages/lf20_2RSPTv.json"
url6 = "https://assets9.lottiefiles.com/packages/lf20_CYBIbn.json"
options_lottie = dict(loop=True, autoplay=True, rendererSettings=dict(preserveAspectRatio='xMidYMid slice'))

app.layout = html.Div([
    dcc.Location(id='url', refresh=False),
    html.Div([
        html.Div(de.Lottie(options=options_lottie, width="70%", height="70%", url=url5), className="lottieContainer"),
